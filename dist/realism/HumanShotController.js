...
export class HumanShotController {
 ...
 if(this.active){this.phase=Math.min(1,this.phase+dt/duration*(1-.45*smooth((this.phase-.76)/.08))*(1-this.impactLoss)*(input.intent?.continuous?(input.intent.released?1.16:.90):1));if(this.phase>=1){this.active=false;this.finished=true;input.stroke=null;}}
